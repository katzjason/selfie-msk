...
export default function Capture() {
  ...
  return (
    <div className="relative flex flex-col min-h-[100dvh] pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] justify-center">
      ...
      {!stream && cameraError && !isLoadingCamera && (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black text-white">
      ...
      {stream && !cameraError && <main className="flex-1 flex flex-col p-2 w-full mx-auto overflow-hidden bg-black justify-center pb-4">
